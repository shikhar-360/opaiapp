...
<div class="container">
    ...
    <form action="{{ route('admin.packages.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="plan_code" value="{{ old('plan_code') }}" class="form-control">
        ...
        <div class="mb-3">
            <label>ROI (%)</label>
            <input type="number" name="roi_percent" step="0.01" value="{{ old('roi_percent') }}" class="form-control">

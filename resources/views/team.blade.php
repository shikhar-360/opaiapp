        ...
        <table id="tabledata1"
          ...
          <tbody class="divide-y divide-slate-100">
            ...
            <tr class="hover:bg-slate-200 transition">
              ...
              <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">MT1001</td>
              <td class="px-4 sm:px-5 py-3 text-slate-800">SP2001</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-01 11:24:10</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-02 09:05:44</td>
              <td class="px-4 sm:px-5 py-3">
                <span
              ...
              <td class="px-4 sm:px-5 py-3 text-right text-slate-900">1</td>
            </tr>
            ...
            <tr class="hover:bg-slate-200 transition">
              ...
              <td class="px-4 sm:px-5 py-3 text-emerald-600">$750</td>
              <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">MT1002</td>
              <td class="px-4 sm:px-5 py-3 text-slate-800">SP2001</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-03 13:17:20</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-04 10:12:37</td>
              <td class="px-4 sm:px-5 py-3">
                <span
            ...
            <tr class="hover:bg-slate-200 transition">
              ...
              <td class="px-4 sm:px-5 py-3 text-emerald-600">$1,500</td>
              <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">MT1003</td>
              <td class="px-4 sm:px-5 py-3 text-slate-800">SP2002</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-05 15:08:42</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-06 12:00:10</td>
              <td class="px-4 sm:px-5 py-3">
                <span
              ...
              <td class="px-4 sm:px-5 py-3 text-right text-slate-900">2</td>
            </tr>
            ...
            <tr class="hover:bg-slate-200 transition">
              ...
              <td class="px-4 sm:px-5 py-3 text-emerald-600">$300</td>
              <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">MT1004</td>
              <td class="px-4 sm:px-5 py-3 text-slate-800">SP2003</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-07 16:54:11</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-08 11:22:31</td>
              <td class="px-4 sm:px-5 py-3">
                <span
            ...
            <tr class="hover:bg-slate-200 transition">
              ...
              <td class="px-4 sm:px-5 py-3 text-emerald-600">$3,000</td>
              <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">MT1005</td>
              <td class="px-4 sm:px-5 py-3 text-slate-800">SP2002</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-09 18:21:56</td>
              <td class="px-4 sm:px-5 py-3 text-slate-700">2025-09-10 13:45:09</td>
              <td class="px-4 sm:px-5 py-3">
                <span
              ...
              <td class="px-4 sm:px-5 py-3 text-right text-slate-900">3</td>
            </tr>
          </tbody>
        </table>

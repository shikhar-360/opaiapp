    ...
    <div class="relative rounded-2xl">
      ...
      <div
        ...
        <div class="pointer-events-none absolute inset-0 opacity-70">
          <div class="absolute -top-24 -left-24 h-40 w-40 rounded-full bg-sky-200 blur-3xl group-hover:translate-y-3 transition-transform duration-300"></div>
        ...
        <div class="mt-4 flex flex-col items-center relative z-10">
          ...
          <div class="w-full flex-1 mt-3 text-center">
            ...
            <p class="mb-4 leading-relaxed mx-auto max-w-sm text-slate-600 text-sm">
              Create your account and connect your wallet to access your dashboard, earnings and staking panel.
            </p>
            ...
            <div class="mx-auto max-w-sm mt-8">
              <button
                ...
                class="relative w-full mx-auto max-w-52 px-5 py-3 cursor-pointer 
                       ...
                       rounded-lg border border-sky-500 whitespace-nowrap

...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5 mb-5">
  ...
  <h2 class="text-lg font-semibold mb-3 text-slate-900">My Directs</h2>
    ...
    <div class="relative mb-6">
      ...
      <div
        ...
        <ul class="flex gap-2" data-tabs-toggle="#default-tab-content" role="tablist">
          ...
          <li role="presentation">
            <button id="table-active_directs" data-tabs-target="#active_directs" type="button" role="tab"
              ...
              class="group relative px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold
                     transition flex items-center gap-2">
              <span class="relative z-[1]">Active Directs</span>
              <span
        ...
        <div class="hidden sm:flex items-center gap-2 text-[11px] text-slate-500 pr-2">
          ...
          <span>Click tabs to switch between Total / Active directs</span>
        </div>
      </div>
    </div>
            ...
            <table id="tabledata1"
              ...
              <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-200 transition">
                  ...
                  <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">0xA1B2...9F01</td>
                  <td class="px-4 sm:px-5 py-3 text-black">5</td>
                  <td class="px-4 sm:px-5 py-3 text-black">18</td>
                  <td class="px-4 sm:px-5 py-3 text-emerald-600">$500</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-01 11:24:10</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-02 09:05:44</td>
                ...
                <tr class="hover:bg-slate-200 transition">
                  ...
                  <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">0xC3D4...2A11</td>
                  <td class="px-4 sm:px-5 py-3 text-black">3</td>
                  <td class="px-4 sm:px-5 py-3 text-black">9</td>
                  <td class="px-4 sm:px-5 py-3 text-emerald-600">$250</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-03 13:17:20</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-04 10:12:37</td>
                  <td class="px-4 sm:px-5 py-3 text-black">
                    <span
                ...
                <tr class="hover:bg-slate-200 transition">
                  ...
                  <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">0xE5F6...3B22</td>
                  <td class="px-4 sm:px-5 py-3 text-black">8</td>
                  <td class="px-4 sm:px-5 py-3 text-black">27</td>
                  <td class="px-4 sm:px-5 py-3 text-emerald-600">$1,000</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-05 15:08:42</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-06 12:00:10</td>
                  <td class="px-4 sm:px-5 py-3">
                    <span
                      class="inline-flex items-center rounded-full bg-yellow-50 px-2 py-0.5 text-[11px] text-yellow-700 border border-yellow-300">
                      Gold
                    </span>
                  </td>
                ...
                <tr class="hover:bg-slate-200 transition">
                  ...
                  <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">0x1122...4C33</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2</td>
                  <td class="px-4 sm:px-5 py-3 text-black">6</td>
                  <td class="px-4 sm:px-5 py-3 text-emerald-600">$150</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-07 16:54:11</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-08 11:22:31</td>
                  <td class="px-4 sm:px-5 py-3">
                    <span
                      class="inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-[11px] text-slate-700 border border-slate-300">
                      Starter
                ...
                <tr class="hover:bg-slate-200 transition">
                  ...
                  <td class="px-4 sm:px-5 py-3 font-mono text-[11px] text-slate-500">0x7788...5D44</td>
                  <td class="px-4 sm:px-5 py-3 text-black">10</td>
                  <td class="px-4 sm:px-5 py-3 text-black">40</td>
                  <td class="px-4 sm:px-5 py-3 text-emerald-600">$2,000</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-09 18:21:56</td>
                  <td class="px-4 sm:px-5 py-3 text-black">2025-09-10 13:45:09</td>
                  <td class="px-4 sm:px-5 py-3 text-black">
                    <span
                      class="inline-flex items-center rounded-full bg-fuchsia-50 px-2 py-0.5 text-[11px] text-fuchsia-700 border border-fuchsia-300">
                      Platinum
                    </span>
                  </td>

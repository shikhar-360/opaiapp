...
<section class="min-h-screen py-8 bg-slate-50/50 px-4">
  <div class="mx-auto max-w-[1470px]">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-4">
      <div>
        <h2 class="text-lg sm:text-2xl font-semibold text-slate-900">Educare</h2>
        <p class="text-xs sm:text-sm text-slate-500">Learning resources & updates will be available here.</p>
      </div>
    </div>

            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 h-full">
                        <div class="col-span-1 grid grid-cols-1 h-full">
                            ...
                            {{-- MAIN PROFILE CARD --}}
                            <form method="POST" action="{{ route('customer.profile.save') }}" enctype="multipart/form-data"
                   ...
                   hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(59,130,246,0.20)]">
                                    ...
                                    <div class="pointer-events-none absolute inset-0 opacity-70">
                                        <div
                                            class="absolute -top-24 -left-24 w-64 h-64 bg-[var(--theme-skky-300)]/20 rounded-full blur-3xl">
                                        </div>
                                        <div
                                            class="absolute -bottom-24 -right-24 w-64 h-64 bg-blue-400/15 rounded-full blur-3xl">
                                        </div>
                                    </div>
                         ...
                         border border-[var(--theme-skky-500)] shadow-md hover:bg-sky-700 active:scale-95 transition">
                                                <svg class="w-4.5 h-4.5" viewBox="0 0 24 24" fill="none">
                                                    <path
                                                        d="M9 7l1.2-2h3.6L15 7h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2Z"
                                                        stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path d="M12 17a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" stroke="currentColor"
                                        ...
                                        <div class="min-w-0">
                                            <h3
                                                class="text-base sm:text-lg font-semibold text-slate-900 leading-tight truncate">
                         ...
                         font-medium text-[var(--theme-primary-text)]">
                                                    <img src="/assets/images/rank/emerald-rank.webp" alt="Rank"
                                                        class="w-8 h-8 object-contain">
                                                    Rank: <span class="font-semibold">Emerald</span>
                                                </span>
                                                ...
                                                <span
                                                    ...
                                                    Vip Level: <span class="font-semibold text-slate-900"> 1 </span>
                                                </span>
                                            </div>
                             ...
                             focus-within:bg-[var(--theme-skkky-50)]/60 transition-colors">
                                                ...
                                                <div
                                                    ...
                                                    <svg class="shrink-0 size-4 text-emerald-500"
                           ...
                           focus-within:bg-sky-50/60 transition-colors">
                                                <input type="text" id="telegram_username" name="telegram_username"
                                                    value="{{ $customer->telegram_username }}"
                                                    placeholder="Enter Telegram Username"
                                                    class="w-full bg-transparent text-slate-900 placeholder:text-slate-400 outline-none text-base [caret-color:#60a5fa]"
                                                    required
                                                    aria-describedby="hs-validation-name-success-helper cursor-no-drop"
                                                    disabled>
                                                <div
                                                    class="absolute inset-y-0 right-3 flex items-center pointer-events-none">
                                                    <svg class="shrink-0 size-4 text-emerald-500"
               ...
               hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(15,23,42,0.20)]">
                        ...
                        <div class="pointer-events-none absolute inset-0 opacity-60">
                            <div
                                class="absolute -top-24 -right-24 w-64 h-64 bg-[var(--theme-skky-300)]/20 rounded-full blur-3xl">
                            </div>
                        </div>
                       ...
                       border border-slate-200">
                        ...
                        {{-- Password form --}}
                        <form method="POST" action="{{ route('customer.profile.save') }}"
                     ...
                     border border-slate-200 bg-white 
                         focus-within:border-[var(--theme-skky-400)] focus-within:ring-1 focus-within:ring-[var(--theme-[var(--theme-skky-100)])] 
                         focus-within:bg-[var(--theme-skkky-50)]/60 transition-colors">
                                    <svg class="w-6 h-6 min-w-6 min-h-6 text-slate-500" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12" cy="16" r="2" stroke="#0f172a" stroke-width="1.5">
                                        </circle>
                                        <path
                    ...
                    <div class="grid grid-cols-1 h-full">
                     ...
                     hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(59,130,246,0.20)] h-full">
                            ...
                            <div class="pointer-events-none absolute inset-0 opacity-70">
                                ...
                                <div class="absolute -bottom-24 -right-24 w-64 h-64 bg-blue-400/15 rounded-full blur-3xl">
                                </div>
                            </div>

                            <form method="POST" action="{{ route('customer.vote.save') }}" enctype="multipart/form-data"
                                class="w-full relative z-10">
                                @csrf
                                <div class="mx-auto w-full space-y-4">
                             ...
                             focus-within:border-[var(--theme-skky-400)] focus-within:ring-1 focus-within:ring-[var(--theme-[var(--theme-skky-100)])] 
                             focus-within:bg-[var(--theme-skkky-50)]/60 transition-colors">
                                            <input type="text" id="voting_user_id" name="voting_user_id"
                                                value="{{ $customer->mySponsor }}" placeholder="Enter User Id"
                                                class="w-full bg-transparent text-slate-900 placeholder:text-slate-400 outline-none text-base [caret-color:#60a5fa]"
                                                required aria-describedby="hs-validation-name-success-helper">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <div class="relative">
                                            ...
                                            <button type="button" onclick="toggleMultiSelect()" id="multiSelectBtn"
                                    ...
                                    text-sm text-slate-900 cursor-pointer focus:ring-1 focus:ring-[var(--theme-skky-300)]">
                                            ...
                                            <div id="multiSelectDropdown"
                                                ...
                                                <label
                                                    class="flex items-center gap-2 p-2 cursor-pointer hover:bg-slate-100 rounded">

    ...
    <div
      ...
      <div class="flex items-center justify-end gap-3 px-4 md:px-5 py-3 md:py-4 border-t border-slate-200">
        ...
        <button type="button" id="agreeTermsBtn"
                class="rounded-lg px-4 py-2 text-white border border-[var(--theme-skky-200)] bg-gradient-to-r from-[var(--theme-skky-500)] to-[var(--theme-skky-600)] hover:bg-gradient-to-r hover:from-[var(--theme-skky-600)] hover:to-[var(--theme-skky-500)] cursor-pointer">
          I Agree
        </button>
      </div>

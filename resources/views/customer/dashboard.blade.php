            ...
            @for ($i = 1; $i <= 20; $i++)
              ...
              <div class="swiper-slide !w-[140px] sm:!w-[160px] md:!w-[200px]">
                <div
                  ...
                  <strong
                    class="w-10 h-10 border border-sky-300/80 bg-gradient-to-t from-sky-500 to-sky-400 rounded-full flex items-center justify-center {{ $achieved_color }} font-bold text-sm shadow-[0_8px_22px_rgba(56,189,248,.7)]">
                    {{ $i }}
                  </strong>
                </div>
              </div>
      ...
      <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-sky-600">{{ $customer->mySponsor }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-sky-600">{{ $customer->totalDirectsCount }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-sky-600">{{ $customer->totalActiveDirectsCount }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-sky-600">{{ $customer->myFirstDepositAt }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-sky-600">{{ $customer->myInvestment }}</p>
          </div>
        </div>

          ...
          <div class="relative flex items-center gap-3 sm:gap-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="text-start mt-2">
                <p class="text-lg sm:text-lg font-semibold text-slate-900 leading-none">{{ $customer->myReferralLevel }}</p>
              </div>
            </div>
          </div>
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 sm:p-4 shadow-md backdrop-blur-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div class="relative flex items-center gap-3 sm:gap-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="text-start mt-2">
                <p class="text-lg sm:text-lg font-semibold text-slate-900 leading-none">{{ $customer->totalTeamCount }} </p>
              </div>
            </div>
          </div>
  ...
  <div class="relative flex items-center gap-3 sm:gap-4 w-full">
    ...
    <div class="flex-1">
      ...
      <div class="w-full bg-slate-200 rounded-full h-2.5">
        ...
        {{-- Total Income --}}
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 sm:p-4 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1.5">
      ...
      <div class=" grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-lg font-bold text-[var(--theme-high-text)] mt-1">#{{ $customer->mySponsor }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-lg font-bold text-[var(--theme-high-text)] mt-1">{{  $customer->totalDirectsCount }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-lg font-bold text-[var(--theme-high-text)] mt-1">{{ $customer->myFirstDepositAt?date('d-m-Y', strtotime($customer->myFirstDepositAt)):'-' }}</p>
          </div>
        </div>
        ...
        <div class="neo-card gap-4 flex items-center bg-white border border-slate-200 rounded-2xl shadow-md">
          ...
          <div>
            ...
            <p class="text-lg font-bold text-[var(--theme-high-text)] mt-1">{{ number_format($customer->myInvestment, 2, '.', '') }} {{ $customer->appData->currency }}</p>
          </div>
        </div>

        ...
        <div class="relative rounded-2xl">
            ...
            <div class="relative p-6 md:p-8 rounded-2xl w-full mx-auto group overflow-hidden neo-card border !border-blue-300/60
               ...
               hover:-translate-y-1.5 ">
                ...
                <div class="pointer-events-none absolute inset-0 opacity-70">
                    <div
                        class="absolute -top-24 -left-24 h-40 w-40 rounded-full bg-[var(--theme-skky-200)]/60 blur-3xl group-hover:translate-y-3 transition-transform duration-300">
                    </div>
                    <div
                        class="absolute -bottom-24 -right-24 h-44 w-44 rounded-full bg-indigo-200/60 blur-3xl group-hover:-translate-y-1 transition-transform duration-300">
                    </div>
                </div>
            ...
            <p class="mb-4 leading-relaxed mx-auto max-w-sm text-slate-600 text-sm">
              Verify OTP
                        ...
                        <form method="POST" action="{{ route('verifyotp.submit') }}" class="space-y-4 relative z-10">
                            @csrf
                            <div class="relative space-y-5">

                                {{-- username / email --}}
                                <div class="relative flex items-center p-3 rounded-lg gap-3 border border-slate-200 bg-white focus-within:border-[var(--theme-skky-400)] focus-within:ring-1 focus-within:ring-[var(--theme-[var(--theme-skky-100)])] focus-within:bg-[var(--theme-skkky-50)]/60 transition-colors">

                                    <svg class="w-6 h-6 min-w-6 min-h-6 text-slate-500" fill="none" viewBox="0 0 24 24">
                                        <path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5z"
                                            stroke="#0f172a" stroke-width="1.5" />
                                        <path d="M3 22c0-4.4 4-8 9-8s9 3.6 9 8" stroke="#0f172a" stroke-width="1.5"
                                            stroke-linecap="round" />
                                    </svg>

                                    <input type="text" name="email" id="email" placeholder="Email i.e. van@example.com"
                                        required
                            ...
                            <div class="">
                                <button id="btnLogin"
                                    class="relative w-full mx-auto max-w-32 px-4 py-3 cursor-pointer flex items-center justify-center text-base capitalize tracking-wide mt-4 rounded-lg border border-[var(--theme-skky-500)] bg-gradient-to-r from-[var(--theme-skky-500)] via-[var(--theme-cyyan-400)] to-[var(--theme-skky-300)] text-white font-semibold transition-all duration-300 ease-out group hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--theme-skky-400)] focus-visible:ring-offset-2 focus-visible:ring-offset-slate-100">
                                    <span>VERIFY</span>
                ...
                <a href="{{ route('forgot') }}"
                  ...
                  Resend OTP 
                            ...
                            <div class="relative flex items-center justify-center rounded-xl p-3 gap-4 leading-none mx-auto w-full max-w-fit border border-slate-200 bg-white shadow-[0_16px_45px_rgba(15,23,42,0.08)]">

                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        <img align="center" border="0" src="https://ai.vitnixx.com/images/e-logo.jpg" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 44%;max-width: 150px;" class="v-src-width v-src-max-width" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-size: 16px; line-height: 27.2px;">Please
                                                                        follow the link for reseting your
                                                                        password</span></p>
                                                            </div>
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <a href="{{ url('/reset-password/{{$code}}') }}"
                                                                    target="_blank"
                                                                    style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background: linear-gradient(90deg, #a4abb8 0%, #9fa4b2 100%); border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                    <span
                                                                        style="display:block;padding:14px 33px;line-height:120%;"><strong><span
                                                                                style="font-size: 16px; line-height: 19.2px;">Reset
                                                                                Now &rarr;</span></strong>
                                                                    </span>
                                                                </a>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px;"><strong>Trade
                                                                            AI</strong></span></p>
                                                            </div>

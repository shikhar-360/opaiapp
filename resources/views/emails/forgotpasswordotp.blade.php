            ...
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #e3edf9;">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        <img align="center" border="0" src="https://user.ordinarypeopleai.com/assets/images/opailogo.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 44%;max-width: 150px;" class="v-src-width v-src-max-width" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                    ...
                                    <div
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <strong>Hello {{$user->referral_code}},</strong>
                                                            </h1>
                                            ...
                                            <table id="u_content_text_3" style="font-family:'Montserrat',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 30px 30px;font-family:'Montserrat',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-size: 16px; line-height: 27.2px;">OTP to reset password</span></p>
                                                            </div>
                                                            ...
                                                            <div
                                                                style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 170%;font-weight: 500;"><span
                                                                        style="font-size: 14px; line-height: 27.2px;">Ignore
                                                                        if you did not forgot password.</span></p>
                                                            </div>
                                                            <table style="font-family:'Montserrat',sans-serif;"
                                                                role="presentation" cellpadding="0" cellspacing="0"
                                                                width="100%" border="0">
                                                            ...
                                                            <div
                                                                style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;text-align: left;">
                                                                <p style="line-height: 170%;font-weight: 500;"><span
                                                                        style="font-size: 14px; line-height: 27.2px;">Kind
                                                                        Regards, <br> OPAI Team</span></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #cedfff;">
                            <div
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="color: #141414; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px;"><strong>OPAI</strong></span></p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="color: #141414; line-height: 180%; text-align: center; word-wrap: break-word;">

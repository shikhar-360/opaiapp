    ...
    <div class="grid grid-cols-1 gap-5 max-w-2xl mx-auto w-full">
      <div
        ...
        <div
          ...
          <span class="text-sm font-semibold text-sky-700">$0</span>
        </div>

        <form class="relative mt-2 space-y-4" method="post" action="https://dapp.OpAi.farm/process-package">
          <input type="hidden" name="_method" value="POST">
          <input type="hidden" name="_token" value="5vBVmbkfmAIwikpkGkO8ioX9AHgeiLClTQICH4Pd" autocomplete="off">
          ...
          <div class="space-y-1.5 relative z-10">
            ...
            <div
              ...
              <input type="hidden" name="unique_th" value="120251203090326">

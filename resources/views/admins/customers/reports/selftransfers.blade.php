...
<div class="container-fluid">
    ...
    <h2 class="mb-3">User Self Transfers</h2>
    ...
    <table id="selftransfer_datatable" class="table table-bordered table-striped table-sm">
        <thead>
        <tr>
            <th>#</th>
            <th>Withdraw Date</th>
        ...
        <tbody>
        @foreach($selftransfer_details as $d)
            <tr>
...
$(document).ready(function () {
  $('#selftransfer_datatable').DataTable({
      pageLength: 5,
